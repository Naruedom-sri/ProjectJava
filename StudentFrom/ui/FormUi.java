...
import file.FileCourseRepo;
import file.FileStudentRepo;
import repository.MemCourseRepo;
import repository.MemStudentRepo;
import servicesz.FormService;
...
public class FormUi {
    ...
    public FormUi(boolean fromFile) {
        if (fromFile) {
    ...
    public void start() {
        // service.addStudent("Shark", "1");
        // service.addStudent("Monkey", "2");
        // service.addStudent("Goat", "1");
        // service.addStudent("Chicken", "4");
        // service.addStudent("Fish", "4");
        // service.addStudent("Dolphin", "2");
        // service.addStudent("Whale", "3");
        // service.addCourse("Magic of numbers");
        // service.addCourse("Transfiguration");
        // service.addCourse("Defense against the dark arts");
        // service.addCourse("Scientific predictions");
        login();
    }
